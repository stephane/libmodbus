...
modbus_t* modbus_new_tcp(const char *ip, int port)
{
    ...
    ctx = (modbus_t *) allocators.malloc(sizeof(modbus_t));
    ...
    ctx->backend_data = (modbus_tcp_t *) allocators.malloc(sizeof(modbus_tcp_t));
...
modbus_t* modbus_new_tcp_pi(const char *node, const char *service)
{
    ...
    ctx->backend_data = (modbus_tcp_pi_t *) allocators.malloc(sizeof(modbus_tcp_pi_t));
