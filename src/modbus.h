...
#define MODBUS_MAX_WRITE_FILE_RECORDS      120
#define MODBUS_MAX_READ_FILE_RECORDS      120
...
void modbus_set_allocators(void* (*malloc)(size_t sz),void* (*realloc)(void *ptr, size_t sz),
                           void* (*calloc)(size_t num,size_t sz),void (*free)(void *ptr));
