...
int modbus_rtu_set_rts(modbus_t *ctx, int mode)
{
  ...
  switch(mode)
  {
    case MODBUS_RTU_RTS_NONE: serial_mode = MODBUS_SERIAL_RTS_NONE; break;
    case MODBUS_RTU_RTS_UP:   serial_mode = MODBUS_SERIAL_RTS_UP;   break;
    case MODBUS_RTU_RTS_DOWN: serial_mode = MODBUS_SERIAL_RTS_DOWN; break;
    default:                  serial_mode = -1;                     break;
  }
...
int modbus_rtu_get_rts(modbus_t *ctx)
{
  ...
  switch(serial_mode)
  {
    case MODBUS_SERIAL_RTS_NONE: return MODBUS_RTU_RTS_NONE;
    case MODBUS_SERIAL_RTS_UP:   return MODBUS_RTU_RTS_UP;
    case MODBUS_SERIAL_RTS_DOWN: return MODBUS_RTU_RTS_DOWN;
    default:                     return -1;
  }
}
